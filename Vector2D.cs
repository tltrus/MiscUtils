...
namespace MiscUtils
{
    namespace Vectors
    {
        ...
        public class Vector2D
        {
            ...
            public Vector2D Add(double x, double y) => new Vector2D(X + x, Y + y);
            ...
            /// <param name="y"></param>
            /// <returns>Возвращает новый вектор и изменяет текущий</returns>
            public Vector2D Sub(double x, double y) => new Vector2D(X - x, Y - y);
            ...
            /// <param name="n"></param>
            /// <returns>Возвращает новый вектор и изменяет текущий</returns>
            public Vector2D Div(double n) => new Vector2D(X / n, Y / n);
            ...
            /// <param name="v"></param>
            /// <returns>Возвращает новый вектор и изменяет текущий</returns>
            public Vector2D Div(Vector2D v) => new Vector2D(X / v.X, Y / v.Y);
            ...
            /// <param name="n"></param>
            /// <returns>Возвращает новый вектор и изменяет текущий</returns>
            public Vector2D Mult(double n) => new Vector2D(X * n, Y * n);
